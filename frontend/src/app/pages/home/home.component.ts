...
@Component({
  selector: 'app-home',
  standalone: true,
  imports: [RouterLink, PropertyCardComponent, AiChatbotComponent],
  template: `
    <!-- Hero Section -->
    <section class="hero">
      <div class="hero-bg">
      ...
      <div class="container">
        <div class="hero-content">
          ...
          <div class="hero-actions animate-fade-in-up delay-3">
            ...
            <a [routerLink]="auth.isOwner() ? '/owner/properties/new' : '/register'" class="btn btn-secondary btn-lg">
              List Your Property
            </a>
          </div>
    ...
    <!-- AI Features Section -->
    <section class="section ai-features">
      <div class="container">
        <div class="section-header text-center">
          <span class="section-tag animate-fade-in-up">Powered by AI</span>
          <h2 class="animate-fade-in-up delay-1">Smart Features to Help You</h2>
          <p class="section-subtitle animate-fade-in-up delay-2">
            Our Gemini AI-powered tools make finding and listing properties faster and smarter
          </p>
        </div>

        <div class="ai-features-grid">
          <div class="ai-feature-card animate-fade-in-up delay-1">
            <div class="feature-icon">
              <span class="material-icons-outlined">support_agent</span>
            </div>
            <h3>24/7 AI Support</h3>
            <p>Get instant answers to your questions about the platform, booking process, and property features. Our AI assistant is always ready to help.</p>
            <div class="feature-badge">Available on all pages</div>
          </div>

          <div class="ai-feature-card animate-fade-in-up delay-2">
            <div class="feature-icon">
              <span class="material-icons-outlined">calculate</span>
            </div>
            <h3>Smart Price Calculator</h3>
            <p>Property owners get AI-powered rental price estimates based on location, size, and market trends to set competitive rates.</p>
            <div class="feature-badge">For property owners</div>
          </div>

          <div class="ai-feature-card animate-fade-in-up delay-3">
            <div class="feature-icon">
              <span class="material-icons-outlined">auto_awesome</span>
            </div>
            <h3>Description Enhancer</h3>
            <p>Transform basic property descriptions into professional, engaging listings with one click using AI-powered copywriting.</p>
            <div class="feature-badge">Save 15+ minutes</div>
          </div>

          <div class="ai-feature-card animate-fade-in-up delay-4">
            <div class="feature-icon">
              <span class="material-icons-outlined">lightbulb</span>
            </div>
            <h3>Smart Search Suggestions</h3>
            <p>Get intelligent search refinements and alternative queries to help you find exactly what you're looking for faster.</p>
            <div class="feature-badge">For all users</div>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="cta-card animate-scale-in">
          <div class="cta-content">
            ...
            <div class="cta-actions">
              <a [routerLink]="auth.isOwner() ? '/owner/properties/new' : '/register'" class="btn btn-accent btn-lg">
                Get Started Free
              </a>
