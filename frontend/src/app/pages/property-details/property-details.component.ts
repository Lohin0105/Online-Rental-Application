          ...
          <div class="details-layout">
            ...
            <main class="details-main">
              ...
              @if (property()!.amenities && property()!.amenities.length > 0) {
                ...
                <section class="reviews-section content-section animate-fade-in-up delay-4">
                          ...
                          <div class="review-header">
                            <div class="reviewer-avatar">
                              @if (review.reviewer_avatar) {
                                ...
                                {{ review.reviewer_name?.charAt(0) || 'T' }}
                              }
                            </div>
                            <div class="reviewer-info">
                              <span class="reviewer-name">{{ review.reviewer_name }}</span>
                              <div class="review-meta">
                                <app-star-rating [value]="review.rating" [readOnly]="true" [size]="14"></app-star-rating>
